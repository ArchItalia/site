...
* [**Core-2023.08.01-x86_64.iso**](https://drive.google.com/file/d/1LLB7pQqdQE5fQCIg2csGqFZ3jM739gmN/view?usp=sharing) is the available image file that has a size of 1.75 GB, running on kernel 6.4.7-arch1-1. 
